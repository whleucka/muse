<section id="player" class="d-flex w-100">
	...
	<div id="controls" class="d-flex align-items-center w-100">
		...
		<button class="btn shuffle active" onClick="shuffle()"><i data-feather="shuffle"></i></button>
		<button class="btn repeat active" onClick="repeat()"><i data-feather="repeat"></i></button>
	</div>
</section>
<audio id="audio" />
